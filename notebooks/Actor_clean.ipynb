{
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "\n",
    "actors = '../data/actor.csv'\n",
    "actor = pd.read_csv(actors)\n",
  ...
  },
  {
   ...
   "source": [
    "duplicate_actor = actor.duplicated().sum()\n",
    "print(duplicate_actor)"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    "column_actor_list = actor.columns.tolist()\n",
    "print(column_actor_list)"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    "rows_with_null = actor.isnull().all(axis=1)\n",
    "\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "actor.to_csv('actory_clean.csv', index=False)"
   ]
  },
  {
   "cell_type": "code",
